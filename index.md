...
I'm a software developer and compiler/programming language nerd. I'm currently working on the [Brossa DSL](https://discourse.haskell.org/t/engineer-at-artificial/5562) at [Artificial](https://artificial.io/).

Previously I worked on the [Rell](https://docs.chromia.com/rell/rell-intro) programming language at [ChromaWay](https://chromaway.com/), and before that I worked at Google on SQL-to-SQL compilers for automatic migration of legacy SQL dialects (Oracle, Teradata etc.) to BigQuery and PostgreSQL. I also worked as a developer at [CompilerWorks](https://www.linkedin.com/company/compilerworks/). I enjoy programming, and especially enjoy projects related to compilers and programming languages. But I'll get stuck into anything that's interesting.
